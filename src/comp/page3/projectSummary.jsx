...
class Project extends Component {
		...
		projects: [
			{
				title: 'FlexiPress',
				short:
					'An efficient compressor able to encode/decode using almost combination of compression sequence possible, achieving super low deflation ratios',
				link: 'https://github.com/tao-luke/FlexiPress',
				svg: (
					<svg
						...
						class="feather feather-database name"
					>
			...
			},
			{
				...
				link: 'https://github.com/faizaanmadhani/choose-your-adventure',
				svg: (
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="24"
	...
	currentThree = () => {
		...
		return [
			this.mymod(offset, 5),
			this.mymod(offset + 1, 5),
			this.mymod(offset + 2, 5),
			this.mymod(offset + 3, 5)
		];
	};
